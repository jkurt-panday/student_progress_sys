...
// TODO add the tables for the teachers
...
export default async function Page( props: {
  ...
  return (
    <main className="border">
      <h1 className="text-6xl font-bold ml-4 mb-4 bg-linear-to-r from-hex-blue via-[#398efd] to-[#ffdca8] bg-clip-text text-transparent">
        Teacher
      </h1>
