...
import { fetchFilteredStudents, fetchFilteredTeachers,
         fetchGradeLevels
 } from "@/app/lib/data";
import { UpdateTeacher, DeleteTeacher, UpdateGradelevel, DeleteGradelevel, UpdateStudent, DeleteStudent} from "../button";
            ...
            <div className="mt-6 flow-root">
                <div className="inline-block min-w-full align-middle">
                    <div className="rounded-lg bg-gray-50 p-2 md:pt-0">
                                ...
                                students?.map((student) => (
                                    ...
                                    >
                                        ...
                                        <div>
                                            ...
                                            <p className="text-sm text-gray-500">Student Number: {student.studentnum}</p>
                                            <p className="text-sm text-gray-500">LRN: {student.lrn}</p>
                                            <p className="text-sm text-gray-500">Guardian: {student.guardianname}</p>
                                            <p className="text-sm text-gray-500">Contact: {student.guardiancontact}</p>
                                        </div>
                                        {/* <InvoiceStatus status={teacher.status} /> */}
                                        </div>
                                        <div className="flex w-full items-center justify-between pt-4">
                        ...
                        {/* // TODO make the data fit in the table */}
                        {/* desktop version */}
                        <table className="hidden min-w-full text-gray-900 md:table">
                            <thead className="rounded-lg text-left text-sm font-normal">
                            <tr>
                            ...
                            {students?.map((student) => (
                                ...
                                <td className="whitespace-nowrap py-3 pl-6 pr-3">
                                    <div className="flex items-center gap-3">
                                    {/* <Image src={teacher.image_url}className="rounded-full" width={28} height={28} alt={`${teacher.name}'s profile picture`} /> */}
